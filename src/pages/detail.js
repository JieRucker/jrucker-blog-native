    ...
    render() {
        ...
        return (
            <View style={{flex: 1, backgroundColor: '#fff'}}>
                ...
                <ScrollView style={{height: AppSizes.screen.height - 200,marginTop:65}}>
                            ...
                            <View style={styles.meta}>
                                {article.category.length
                                    ? <View style={[styles.metaItem, styles.metaItemLeft]}>
                                        <CommunityIcon name="book-open-variant" size={17}
                                                       style={[styles.metaIcon, styles.metaText]}/>
                                        <Text
                                            style={styles.metaText}>{String(article.category.map(c => c.name).join('、'))}</Text>
                                    </View>
                                    : null
                                }
                                <View style={[styles.metaItem, styles.metaItemLeft]}>
                                ...
                                <View style={styles.metaItem}>
                                    <CommunityIcon name="clock" size={17}
                                                   style={[styles.metaIcon, styles.metaText, styles.metaDateIcon]}/>
                    ...
                    {loading
                        ...
                        : <View style={styles.content}>
                            <Markdown style={markdownStyles}>{articleContent}</Markdown>
                        </View>
                    }
                </ScrollView>
                <NavBar leftOn={true}
